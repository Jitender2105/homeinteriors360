...
ALTER TABLE pros
  ...
  ADD COLUMN IF NOT EXISTS office_hours VARCHAR(120) DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS client_count INT DEFAULT NULL,
  ...
  ADD COLUMN IF NOT EXISTS process_steps_json JSON DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS awards_json JSON DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS faq_json JSON DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS response_time_hours INT DEFAULT NULL,
  ADD COLUMN IF NOT EXISTS google_business_url VARCHAR(500) DEFAULT NULL;
